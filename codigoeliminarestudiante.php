...
$$tags2[$i]=$valores2[$i]; 
  ...
  include("config.php");
	...
	$consulta="UPDATE alumnos SET activo='0' WHERE idestudiante = '$IDBusqueda'";
...
<title>.. Eliminaci&oacute;n de Estudiante a la Plataforma Lyons ..</title>
...
<table width="971" height="559" align="center" cellpadding="0" cellspacing="0" background="imagenes/fond.png">
  <tbody><tr>
  ...
  <tr>
    <td height="404" colspan="3" class="fondocwentro"><table width="97%" height="392" cellpadding="0" cellspacing="0">
      <tbody><tr>
							<td width="999" height="376" align="left" valign="top"><table width="969" height="376" border="0">
                              <tr>
                                <td width="963" height="372" valign="top"><form id="form1" name="form1" method="post" action="">
                                  <table width="963" height="190" border="0">
                                    ...
                                    <tr>
                                      <td height="21"><div align="center"><span class="TITULOart1 Estilo18"><a href="plataformaindex_directivos_ingresoestudiante.php">INGRESAR ALUMNO </a></span> </div></td>
                                      <td>&nbsp;</td>
                                      <td><div align="center"><span class="TITULOart1 Estilo18"><a href="plataformaindex_directivos_modificarestudiante.php">MODIFICAR ALUMNO </a></span></div></td>
                                      <td>&nbsp;</td>
                                      <td><div align="center"><span class="TITULOart1 Estilo18"><a href="plataformaindex_directivos_eliminarestudiante.php">ELIMINAR ALUMNO </a></span></div></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      <td height="21" colspan="5"><label>
                                        ...
                                        <div align="center"><span class="TITULOart2">Se ha Eliminado el Estudiante con Exito </span></div>                                        
