...
$$tags2[$i]=$valores2[$i]; 
	...
	$consulta="DELETE FROM directivos WHERE iddirectivo = '$IDBusqueda'";
...
<title>.. Eliminacion de Directivo a la Plataforma Lyons ..</title>
...
<table width="971" height="585" align="center" cellpadding="0" cellspacing="0" background="imagenes/fond.png">
  <tbody><tr>
	  <td width="1001" height="19" colspan="3" align="left" valign="top">&nbsp;</td>
			</tr>


  <tr>
    <td height="110" colspan="3" align="right" valign="top"><table width="101%" height="152" align="left" cellpadding="0" cellspacing="0" background="REVISTA DINERS_files/cabezote_naraja22.png">
      <tbody>
        <tr>
          <td valign="bottom" width="1%" height="150">&nbsp;</td>
          <td width="12%">&nbsp;</td>
          <td width="87%"><p>&nbsp;</p>
              <p>&nbsp;</p>
            <p>&nbsp;</p></td>
  ...
  <tr>
    <td height="431" colspan="3" class="fondocwentro"><table width="92%" height="402" cellpadding="0" cellspacing="0">
      <tbody><tr>
							<td width="999" height="388" align="left" valign="top"><table width="969" height="376" border="0">
                              <tr>
                                <td width="993" height="372" valign="top"><form id="form1" name="form1" method="post" action="">
                                  <table width="963" height="190" border="0">
                                    ...
                                    <tr>
                                      <td height="21"><div align="center"><span class="fmenuTop Estilo18 Estilo20"><a href="plataformaindex_directivos_ingresodirectivos.php" class="TITULOart1">INGRESAR DIRECTIVO</a></span></div></td>
                                      <td>&nbsp;</td>
                                      <td><div align="center"><span class="fmenuTop Estilo18"><a href="plataformaindex_directivos_modificardirectivos.php">MODIFICAR DIRECTIVO </a></span></div></td>
                                      <td>&nbsp;</td>
                                      <td><div align="center"><span class="fmenuTop Estilo18"><a href="plataformaindex_directivos_eliminardirectivos.php">ELIMINAR DIRECTIVO</a></span></div></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      <td height="21" colspan="5"><label>
                                        ...
                                        <div align="center"><span class="TITULOart2">Se ha Eliminado el Directivo</span></div>                                        
                                    ...
                                    <tr>
                                      ...
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                                      <td><div align="center" class="fmenuTop Estilo18"><a href="plataformaindex_directivos.php"><a href="plataformaindex_directivos.php"><img src="imagenes/go-home.png" width="50" height="50" border="0" /></a></div></td>
                                    </tr>
                                  </table>
                                                                </form>
                                </td>
